...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.user.role === 'SUPER_ADMIN' || result.user.role === 'ADMIN' || result.user.role === 'OPERATOR') {
        navigate('/admin');
      } else {
        navigate('/dashboard');
      }
        ...
        <div className="auth-brand">
          ...
          <div className="auth-welcome">
            ...
            <p className="auth-welcome-subtitle">
              Sign in to your account and continue your journey with Booksync. 
              Book tickets, manage your profile, and track your travels across Malawi.
            </p>
          </div>
